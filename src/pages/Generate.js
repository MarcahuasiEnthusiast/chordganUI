...
import generateVideo2 from '../assets/generateVideo2.mp4';
import {
  Button,
  Typography,
  Divider,
...
class Generate extends Component {
  ...
  async generate() {
    ...
    await fetch('https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/config_inference', requestOptions).catch(error => {
    ...
    .then(
      fetch('https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/generate').catch(error => {
        console.log(error);
        this.setState({generationWaitingForResponse: false})
        this.handleClick()
      })
      ...
      .then(data => {
        ...
        if (generateResponse == "200" || generateResponse == 200) {
          ...
          fetch('https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/listMidiFiles').then(response => response.json()).then(data => this.setState({success: true, filesArray: data})).then(data => console.log("FILES ARRAY:", data))
        }
        else {
  ...
  async downloadAll() {
    ...
    fetch('https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/get-files', {
      method: 'GET',
      headers: {
  ...
  async selectedMIDIHandler(e, obj) {
    ...
    await fetch('https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/getFile', requestOptions).then((response) => {
              ...
              <CardContent >
                ...
                <div className='upper-panel'>
                  ...
                  <Stack direction="row" spacing={3}  className='lowerPanelStyling' >
                    ...
                    {/* <Button href="https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/get-files" disabled={this.state.downloadDisabled} variant="contained" className='Download-Button' sx={generateButtonStyling} download="generated.zip">Download</Button> */}
                  </Stack>
                </div>
                      ...
                      <div className='lower-panel'>
                        ...
                        <Stack direction="row" sx={{textAlign:'center'}} spacing={1} divider={<Divider orientation="vertical" flexItem />} className='lowerPanelStyling' >
                          ...
                          <div className='downloadButtonStyling'>
                            <CustomButton type='submit' href='https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/getFile' disabled={this.state.selectedMIDI && false} sx={{borderRadius: 45, width: 105, fontSize:'12px', right:30, top:5}} variant="text"  download={this.state.selectedMIDI}>Download Selected</CustomButton>
                          </div>
                          <div className='downloadButtonStyling'>
                            <CustomButton href="https://ec2-54-144-102-108.compute-1.amazonaws.com:6565/get-files" disabled={this.state.downloadDisabled} sx={{borderRadius: 65, width: 105, fontSize:'12px', right:30, top:5}} variant="text" className='Download-Button'  download="generated.zip">Download All</CustomButton>
                          </div>
                        </Stack>
